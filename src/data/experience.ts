...
export const experiences: Experience[] = [
  {
    ...
    skills: ['React', 'Preact', 'TypeScript', 'CSS Modules', 'System Architecture'],
  },
  {
    ...
    skills: ['JavaScript', 'HTML/SCSS', 'Pendo', 'Google Tag Manager'],
  },
  {
    ...
    skills: ['React', 'TypeScript', 'Responsive Design', 'Mobile-First', 'PayPal API', 'Form Development'],
  },
];
