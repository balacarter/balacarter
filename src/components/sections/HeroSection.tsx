...
// Lazy load HeroImage for better performance
const HeroImage = dynamic(() => import('@/components/HeroImage'), {
  ssr: false,
  loading: () => <div className="fixed top-0 right-0 w-full h-screen -z-10" />,
});
...
export default function HeroSection({ isSidebarVisible }: HeroSectionProps) {
  return (
    ...
    >
      ...
      <ErrorBoundary fallback={<div className="fixed top-0 right-0 w-full h-screen -z-10" />}>
        <HeroImage />
      </ErrorBoundary>
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col justify-center space-y-8 col-span-2 max-w-sm md:max-w-lg lg:max-w-3xl">
            {/* Name and Title - Above Hero Text (Hidden on Desktop when sidebar visible) */}
            {!isSidebarVisible && (
              <div className="mb-4">
